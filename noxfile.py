...
def dagster_postgres(session):
    ...
    # `dagster dev` does two things
    # 1. start code-server
    #    /home/michael/git/repos/OpenStudioLandscapes/.venv/bin/python -m dagster code-server start --socket /tmp/tmp93eroncq --heartbeat --heartbeat-timeout 45 --fixed-server-id f216afc6-ed4f-43e6-88ea-335ab9a6dbc4 --log-level INFO --inject-env-vars-from-instance --instance-ref {"__class__": "InstanceRef", "compute_logs_data": {"__class__": "ConfigurableClassData", "class_name": "LocalComputeLogManager", "config_yaml": "base_dir: /home/michael/git/repos/OpenStudioLandscapes/.dagster-postgres/storage\n", "module_name": "dagster.core.storage.local_compute_log_manager"}, "custom_instance_class_data": null, "event_storage_data": {"__class__": "ConfigurableClassData", "class_name": "PostgresEventLogStorage", "config_yaml": "postgres_db:\n  db_name: postgres\n  hostname: localhost\n  password: mysecretpassword\n  port: 2345\n  username: postgres\n", "module_name": "dagster_postgres"}, "local_artifact_storage_data": {"__class__": "ConfigurableClassData", "class_name": "LocalArtifactStorage", "config_yaml": "base_dir: /home/michael/git/repos/OpenStudioLandscapes/.dagster-postgres\n", "module_name": "dagster.core.storage.root"}, "run_coordinator_data": {"__class__": "ConfigurableClassData", "class_name": "QueuedRunCoordinator", "config_yaml": "block_op_concurrency_limited_runs:\n  enabled: true\nmax_concurrent_runs: 1\n", "module_name": "dagster.core.run_coordinator"}, "run_launcher_data": {"__class__": "ConfigurableClassData", "class_name": "DefaultRunLauncher", "config_yaml": "{}\n", "module_name": "dagster"}, "run_storage_data": {"__class__": "ConfigurableClassData", "class_name": "PostgresRunStorage", "config_yaml": "postgres_db:\n  db_name: postgres\n  hostname: localhost\n  password: mysecretpassword\n  port: 2345\n  username: postgres\n", "module_name": "dagster_postgres"}, "schedule_storage_data": {"__class__": "ConfigurableClassData", "class_name": "PostgresScheduleStorage", "config_yaml": "postgres_db:\n  db_name: postgres\n  hostname: localhost\n  password: mysecretpassword\n  port: 2345\n  username: postgres\n", "module_name": "dagster_postgres"}, "scheduler_data": {"__class__": "ConfigurableClassData", "class_name": "DagsterDaemonScheduler", "config_yaml": "{}\n", "module_name": "dagster.core.scheduler"}, "secrets_loader_data": null, "settings": {"auto_materialize": {"enabled": true, "use_sensors": true}, "telemetry": {"enabled": false}}, "storage_data": {"__class__": "ConfigurableClassData", "class_name": "DagsterPostgresStorage", "config_yaml": "postgres_db:\n  db_name: postgres\n  hostname: localhost\n  password: mysecretpassword\n  port: 2345\n  username: postgres\n", "module_name": "dagster_postgres"}} --location-name OpenStudioLandscapes Engine -m OpenStudioLandscapes.engine.definitions
    # 2. start dagster-webserver
    #    /home/michael/git/repos/OpenStudioLandscapes/.venv/bin/python -m dagster_webserver --host 0.0.0.0 --dagster-log-level info --log-format colored --live-data-poll-rate 2000 --instance-ref {"__class__": "InstanceRef", "compute_logs_data": {"__class__": "ConfigurableClassData", "class_name": "LocalComputeLogManager", "config_yaml": "base_dir: /home/michael/git/repos/OpenStudioLandscapes/.dagster-postgres/storage\n", "module_name": "dagster.core.storage.local_compute_log_manager"}, "custom_instance_class_data": null, "event_storage_data": {"__class__": "ConfigurableClassData", "class_name": "PostgresEventLogStorage", "config_yaml": "postgres_db:\n  db_name: postgres\n  hostname: localhost\n  password: mysecretpassword\n  port: 2345\n  username: postgres\n", "module_name": "dagster_postgres"}, "local_artifact_storage_data": {"__class__": "ConfigurableClassData", "class_name": "LocalArtifactStorage", "config_yaml": "base_dir: /home/michael/git/repos/OpenStudioLandscapes/.dagster-postgres\n", "module_name": "dagster.core.storage.root"}, "run_coordinator_data": {"__class__": "ConfigurableClassData", "class_name": "QueuedRunCoordinator", "config_yaml": "block_op_concurrency_limited_runs:\n  enabled: true\nmax_concurrent_runs: 1\n", "module_name": "dagster.core.run_coordinator"}, "run_launcher_data": {"__class__": "ConfigurableClassData", "class_name": "DefaultRunLauncher", "config_yaml": "{}\n", "module_name": "dagster"}, "run_storage_data": {"__class__": "ConfigurableClassData", "class_name": "PostgresRunStorage", "config_yaml": "postgres_db:\n  db_name: postgres\n  hostname: localhost\n  password: mysecretpassword\n  port: 2345\n  username: postgres\n", "module_name": "dagster_postgres"}, "schedule_storage_data": {"__class__": "ConfigurableClassData", "class_name": "PostgresScheduleStorage", "config_yaml": "postgres_db:\n  db_name: postgres\n  hostname: localhost\n  password: mysecretpassword\n  port: 2345\n  username: postgres\n", "module_name": "dagster_postgres"}, "scheduler_data": {"__class__": "ConfigurableClassData", "class_name": "DagsterDaemonScheduler", "config_yaml": "{}\n", "module_name": "dagster.core.scheduler"}, "secrets_loader_data": null, "settings": {"auto_materialize": {"enabled": true, "use_sensors": true}, "telemetry": {"enabled": false}}, "storage_data": {"__class__": "ConfigurableClassData", "class_name": "DagsterPostgresStorage", "config_yaml": "postgres_db:\n  db_name: postgres\n  hostname: localhost\n  password: mysecretpassword\n  port: 2345\n  username: postgres\n", "module_name": "dagster_postgres"}} --code-server-log-level warning --workspace /tmp/tmpg731jl50/workspace.yaml
    # in order to get IP and port, we might launch these steps
    # individually/manually. It seems like the host info is not easy
    # to query once `dagster dev` has been issued - the two processes don't communicate with each other
